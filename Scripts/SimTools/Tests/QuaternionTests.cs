...
namespace Tests
{
    ...
    public class Quaternion_Tests
    {
        ...
        #region Roll 45 -> Pitch Movements - Pitch Only Movement - Simulator Movement Tests
        // Checks Positive Roll 360
        [Test]
        public void CheckRoll45Pitch360_OriginState_RollOnly()
        {
            //arrange
            _player = new GameObject("Player");
            ...
            pitch90();
            //assert:   check Euler
            checkRotations(0, 0, 45);

            //act:      pitch +90 degrees
            pitch90();
            //assert:   check Euler
            checkRotations(90, 0, 45);

            //act:      pitch +90 degrees
            pitch90();
            //assert:   check Euler
            checkRotations(180, 0, 45);

            //act:      pitch +90 degrees
            pitch90();
            //assert:   check Euler
            checkRotations(270, 0, 45);
        ...
        /// <summary>
        /// DELETE ME THIS IS BAD FORM
        /// </summary>
        #region Setup Functions
        //[SetUp]
        //public void Init()
        //{
        //    this._checkPitch = false;
        //}
        #endregion
